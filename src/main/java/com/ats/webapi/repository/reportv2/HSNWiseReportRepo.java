...
public interface HSNWiseReportRepo extends JpaRepository<HSNWiseReport, Integer> {
	//Mahendra----->20/09/2020------------->add sub category col. and group by sub category
	@Query(value = "SELECT \r\n" + 
			"			     uuid() AS id, \r\n" + 
			...
			"			    t_bill_detail, \r\n" + 
			"			    m_item, \r\n" + 
			"			    m_cat_sub, m_category\r\n" + 
			"			WHERE \r\n" + 
			"			    t_bill_header.bill_no = t_bill_detail.bill_no AND t_bill_header.bill_date BETWEEN :fromDate AND :toDate AND t_bill_header.del_status = 0 AND t_bill_detail.del_status = 0 AND t_bill_detail.item_id = m_item.id AND m_item.item_grp2 = m_cat_sub.sub_cat_id AND m_category.cat_id=m_cat_sub.cat_id and m_category.cat_id=t_bill_detail.cat_id and t_bill_detail.cat_id !=5\r\n" + 
			"			GROUP BY \r\n" + 
			"			    item_hsncd, \r\n" + 
			...
			"			    m_cat_sub, m_category\r\n" + 
			"			WHERE \r\n" + 
			"			    t_bill_header.bill_no = t_bill_detail.bill_no AND t_bill_header.bill_date BETWEEN :fromDate AND :toDate AND t_bill_header.del_status = 0 AND t_bill_detail.del_status = 0 AND t_bill_detail.item_id = m_sp_cake.sp_id  AND 5=m_cat_sub.cat_id and m_category.cat_id=5 and t_bill_detail.cat_id=5\r\n" + 
			"			GROUP BY \r\n" + 
			"			    item_hsncd, \r\n" + 
	...
	"    m_cat_sub\r\n" + 
	"WHERE\r\n" + 
	"    t_bill_header.bill_no = t_bill_detail.bill_no AND t_bill_header.bill_date BETWEEN :fromDate AND :toDate AND t_bill_header.del_status = 0 AND t_bill_detail.del_status = 0 AND t_bill_detail.item_id = m_item.id AND m_item.item_grp2 = m_cat_sub.sub_cat_id\r\n" + 
	"GROUP BY\r\n" + 
	"    item_hsncd,\r\n" + 
	"    m_cat_sub.sub_cat_id
*/	
//	SELECT" + "            t_bill_detail.hsn_code as id,"
...
/*---------------------------------------------------------------------------------------*/
	...
	@Query(value = "SELECT" + "            t_bill_detail.hsn_code as id,"
			...
			+ "            SUM(t_bill_detail.bill_qty) as bill_qty,"
			+ "            SUM(t_bill_detail.taxable_amt) as taxable_amt,"
			+ "            SUM(t_bill_detail.cgst_rs) as cgst_rs," + "            SUM(t_bill_detail.sgst_rs) as sgst_rs,SUM(t_bill_detail.cess_rs) as cess_rs, 'NA' AS sub_cat_name"
	...
	@Query(value = "SELECT" + "        t_credit_note_details.hsn_code AS id,"
			...
			+ "            SUM(t_credit_note_details.sgst_rs) as sgst_rs, SUM(t_credit_note_details.cess_rs) as cess_rs, 'NA' AS subCat" + "        FROM t_credit_note_details,"
	...
	@Query(value = "SELECT" + "        t_credit_note_details.hsn_code AS id,"
			...
			+ "            SUM(t_credit_note_details.taxable_amt) as taxable_amt,"
			+ "            SUM(t_credit_note_details.cgst_rs) as cgst_rs,"
			+ "            SUM(t_credit_note_details.sgst_rs) as sgst_rs,SUM(t_credit_note_details.cess_rs) as cess_rs, 'NA' AS sub_cat_name" + "        FROM t_credit_note_details,"
	...
	//Update on ---->28-09-2020 By Mahendra
	//Desc----> add sub category col. and group by sub category
	@Query(value = "SELECT \r\n" + 
			"			     uuid() AS id, \r\n" + 
			"			    t_credit_note_details.hsn_code AS item_hsncd, \r\n" + 
			"			    t_credit_note_details.sgst_per AS item_tax1, \r\n" + 
			...
			"			    m_cat_sub ,m_category\r\n" + 
			"			WHERE \r\n" + 
			"			    t_credit_note_header.crn_id = t_credit_note_details.crn_id AND t_credit_note_header.crn_date BETWEEN :fromDate AND :toDate AND t_credit_note_details.del_status = 0 AND t_credit_note_details.is_grn IN(:grngvnType) AND t_credit_note_details.item_id=m_item.id AND m_item.item_grp2=m_cat_sub.sub_cat_id and m_category.cat_id=m_cat_sub.cat_id and t_credit_note_details.cat_id=m_category.cat_id and t_credit_note_details.cat_id  !=5 and t_credit_note_details.cat_id=m_category.cat_id\r\n" + 
			"			GROUP BY \r\n" + 
			"			    item_hsncd, \r\n" + 
			"			    m_cat_sub.sub_cat_id\r\n" + 
			"                UNION ALL\r\n" + 
			...
			"			    m_cat_sub ,m_category\r\n" + 
			"			WHERE \r\n" + 
			"			    t_credit_note_header.crn_id = t_credit_note_details.crn_id AND t_credit_note_header.crn_date BETWEEN :fromDate AND :toDate AND t_credit_note_details.del_status = 0 AND t_credit_note_details.is_grn IN(:grngvnType) AND t_credit_note_details.item_id=m_sp_cake.sp_id  and m_category.cat_id=m_cat_sub.cat_id and t_credit_note_details.cat_id=m_category.cat_id and t_credit_note_details.cat_id  =5 \r\n" + 
			"			GROUP BY \r\n" + 
			"			    item_hsncd, \r\n" + 
			"			    m_cat_sub.sub_cat_id", nativeQuery = true)
	...
	"    m_cat_sub\r\n" + 
	"WHERE\r\n" + 
	"    t_credit_note_header.crn_id = t_credit_note_details.crn_id AND t_credit_note_header.crn_date BETWEEN :fromDate AND :toDate AND t_credit_note_details.del_status = 0 AND t_credit_note_details.is_grn IN(:grngvnType) AND t_credit_note_details.item_id=m_item.id AND m_item.item_grp2=m_cat_sub.sub_cat_id\r\n" + 
	"GROUP BY\r\n" + 
	"    item_hsncd,\r\n" + 
	"    m_cat_sub.sub_cat_id
	*/
...
//	"    ) AS taxable_amt,\r\n" + 
//	"    SUM(t_credit_note_details.cgst_rs) AS cgst_rs,\r\n" + 
//	"    SUM(t_credit_note_details.sgst_rs) AS sgst_rs,SUM(t_credit_note_details.cess_rs) as cess_rs, 'NA' AS sub_cat_name \r\n" + 
//	"FROM\r\n" + 
//	"    t_credit_note_details,\r\n" + 
//	"    t_credit_note_header\r\n" + 
//	"WHERE\r\n" + 
