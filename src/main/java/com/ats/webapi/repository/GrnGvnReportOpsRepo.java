...
public interface GrnGvnReportOpsRepo extends JpaRepository<GrnGvnReportOps, Integer>{
	...
	@Query(value="  select\r\n" + 
			...
			"        g.apr_grand_total as apr_grand_total,   g.grn_gvn_qty,\r\n" + 
			"    g.apr_qty_gate,\r\n" + 
			"    g.apr_qty_store,\r\n" + 
			"    g.apr_qty_acc  \r\n" + 
			"    from\r\n" + 
	...
	List<GrnGvnReportOps> grnGvnReportDateWise( @Param("frId")int frId,@Param("fromDate")String fromDate,@Param("toDate")String toDate,
	...
	@Query(value="  select\r\n" + 
			...
			" order by g.grn_gvn_header_id,tax_rate",nativeQuery=true)
	List<GrnGvnReportOps> grnGvnReportDateWiseOfGvn(@Param("frId")int frId,@Param("fromDate")String fromDate,@Param("toDate")String toDate,
			@Param("isGrn")String isGrn);
	...
	@Query(value="select\r\n" + 
			...
			"			        and g.fr_id=:frId and g.cat_id=5\r\n" + 
			"			 order by g.grn_gvn_header_id,tax_rate	",nativeQuery=true)
	List<GrnGvnReportOps> grnGvnReportDateWiseOfGvnForSp(@Param("frId")int frId,@Param("fromDate")String fromDate,@Param("toDate")String toDate,
			@Param("isGrn")String isGrn);
